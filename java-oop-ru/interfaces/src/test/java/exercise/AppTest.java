...
class AppTest {
    ...
    public void testLength() {
        String originalSequence = "Hello, World!";
        ReversedSequence reversedSequence = new ReversedSequence(originalSequence);
        assertThat(reversedSequence.length()).isEqualTo(originalSequence.length());
    }
    ...
    public void testCharAt() {
        ...
        for (int i = 0; i < originalSequence.length(); i++) {
            assertThat(reversedSequence.charAt(i)).isEqualTo(originalSequence.charAt(originalSequence.length() - 1 - i));
        }
    }
    ...
    public void testToString() {
        String originalSequence = "Hello, World!";
        ReversedSequence reversedSequence = new ReversedSequence(originalSequence);
        String reversedStr = reversedSequence.toString();
        assertThat(reversedStr).isEqualTo("!dlroW ,olleH");
    }
    // END
}
